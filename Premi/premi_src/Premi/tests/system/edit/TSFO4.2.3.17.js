...
describe('TSFO4.2.3.17 - Viene verificato che il sistema selezioni ' +
	'correttamente il titolo di un nodo.',function () {
	...
	it('Deve venir visualizzato il menù contestuale \n' +
		...
		'Deve essere possibile selezionare il titolo\n' +
		...
		element(by.css('*[style="font-size: 114.2%; top: 87.4651810584958%;' +
			' left: 0%; width: auto; height: auto; position: absolute;"] ' +
			'div[class="content draggable-content title"]'))
			.click();

		var firstResizer = element.all(by.css('[style="font-size: 114.2%; ' +
			'top: ' +
			'87.4651810584958%; left: 0%; width: auto; height: auto; ' +
			'position: absolute;"]' +
			' div[class="content draggable-content title"]')).first();
