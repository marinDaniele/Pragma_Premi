...
describe('TSFO4.2.3.4 - Viene verificato che il sistema aggiunga ' +
	...
	it('Deve venir visualizzato il menù contestuale \n' +
		...
		editorPage.editWindow.getContentList().then(function (result) {
			count = result.length;
			editorPage.editWindow.btnAddText.click();
...
describe('TSFO4.2.3.12 - Viene verificato che il sistema elimini ' +
	'correttamente un elemento testuale in un nodo della mappa.',function () {
	...
	it('Deve venir visualizzato il menù contestuale \n' +
		...
		editorPage.editWindow.getContentList().then(function (result) {
			...
			/*
			 *
			 *style="font-size: 114.2%; top: 30%; left: 30%; width: 25.38%; height: 20.53%; position: absolute;"
			 * */

			var textDiv = element(by.css('*[style="font-size: 114.2%; ' +
				'top: 30%; left: 30%; width: auto; height: auto; ' +
				'position: absolute;"] div[class="content draggable-content text"]'));
