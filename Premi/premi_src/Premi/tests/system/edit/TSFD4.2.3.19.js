...
describe('TSFO4.2.3.19 - Viene verificato che il sistema ridimensioni ' +
	...
	it( 'Deve venir visualizzato il menù contestuale\n' +
		...
		element(by.css('*[style="font-size: 114.2%; top: 0%; ' +
			'left: 83.0897703549061%; width: auto; height: auto; ' +
			'position: absolute;"] ' +
			'div[class="content draggable-content text"]'))
			.click();
		...
		var swResizer = element(by.css('[class="sw-resize resize-color ' +
			'ng-scope"]'));

		browser.actions()
			.dragAndDrop(swResizer, {x:600, y:200})
			.perform();


		var resizedElement = element(by.css('[style="font-size: 114.2%; ' +
			'top: 0%; left: 83.0897703549061%; width: auto; ' +
			'height: 51.4018691588785%; position: absolute;"]'));
