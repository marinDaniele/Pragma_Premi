 ...
 * Data: 2015-05-18
 * Descrizione: Test di integrazione TI5 Premi::Front-End::Services::ProjectService metodo "getId"
 */
'use strict';
describe('TI5 Premi::Front-End::Services::ProjectService metodo "getId"', function () {
	...
	//test
	it("Dovrebbe restituire l'identificativo del progetto correntemente caricato in memoria", function () {
		expect(projectService.getId()).toBe('556445fa9bb810da06778091');
	});
});
