/**
 * File: quitToDashboard.js
 * @author gmidena - rockstar249@gmail.com
 * Data: 2015-06-11
 * Descrizione: Test di unità TU58 Premi::Front-End::Controllers::PresentationViewerController metodo "quitToDashboard"
 */
'use strict';
describe('TU58 Premi::Front-End::Controllers::PresentationViewerController metodo "quitToDashboard"', function(){
	...
	//test
	it("Dovrebbe invocare il metodo $location.path, con il parametro '/dashboard'", function(){
		$scope.quitToDashboard();
