 ...
 * Data: 2015-05-18
 * Descrizione: Test di unità TU81 Premi::Front-End::Services::ProjectService metodo "getCurrentProject"
 */
'use strict';
describe('TU81 Premi::Front-End::Services::ProjectService metodo "getCurrentProject"', function () {
	...
	it('Dovrebbe restituire il progetto correntemente caricato in memoria', function () {
		...
		expect(projectService.getCurrentProject()).toEqual(_currentProject);
	});
});
