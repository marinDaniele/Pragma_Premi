 ...
 * Data: 2015-05-18
 * Descrizione: Test di unità TU81 Premi::Front-End::Services::ProjectService metodo "loadProject"
 */
'use strict';
describe('TU81 Premi::Front-End::Services::ProjectService metodo "loadProject"', function () {
	...
	beforeEach(function(){
		...
		inject(function(_projectService_, _$httpBackend_, _SERVER_URL_, _mindmapAdapterService_){
			...
			spyOn(window, 'Project').and.callFake(function (id, name, backgroundColor, fontFamily, textColor, rootId){
			    this._id = id;
			    this._name = name;
