 ...
 * Data: 2015-06-09
 * Descrizione: Test di unità TU79 Premi::Front-End::Services::PathService metodo "removeNodeFromPath"
 */
'use strict';
describe('TU79 Premi::Front-End::Services::PathService metodo "removeNodeFromPath"', function () {
	...
	beforeEach(inject(function(_projectService_, _pathService_, _SERVER_URL_, _$httpBackend_, _$http_, _$rootScope_){
		...
		spyOn(window, 'Path').and.callFake(function(id,name,steps,isDefault){
			return {
			    ...
			    'addStep': function(id, title){this._steps.push(new NodeReference(id, title));}
			};
		});
	}));
