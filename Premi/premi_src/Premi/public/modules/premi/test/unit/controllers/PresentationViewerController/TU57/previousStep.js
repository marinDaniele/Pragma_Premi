/**
 * File: previousStep.js
 * @author gmidena - rockstar249@gmail.com
 * Data: 2015-06-11
 * Descrizione: Test di unità TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "previousStep"
 */
'use strict';
describe('TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "previousStep"', function(){
	...
	//test
	it("Dovrebbe invocare il metodo $scope.$broadcast, con il parametro 'presentation-previousStep'", function(){
		$scope.previousStep();
		expect($scope.$broadcast).toHaveBeenCalledWith('presentation-previousStep');
	});
});
