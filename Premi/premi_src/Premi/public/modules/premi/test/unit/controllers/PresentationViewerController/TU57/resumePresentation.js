/**
 * File: resumePresentation.js
 * @author gmidena - rockstar249@gmail.com
 * Data: 2015-06-11
 * Descrizione: Test di unità TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "resumePresentation"
 */
'use strict';
describe('TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "resumePresentation"', function(){
	...
	beforeEach(function(){
		...
		$scope.resumePresentation();
	});

	//test
	it("Dovrebbe invocare il metodo $scope.$broadcast, con il parametro 'presentation-resumeLinear'", function(){
		expect($scope.$broadcast).toHaveBeenCalledWith('presentation-resumeLinear');
	});

	it("Dovrebbe impostare il valore dell'attributo $scope.linearPresentation a true", function(){
