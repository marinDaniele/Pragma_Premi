 ...
 * Data: 2015-06-11
 * Descrizione: Test di unità TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "nodeChanged"
 */
'use strict';
describe('TU57 Premi::Front-End::Controllers::PresentationViewerController metodo "nodeChanged"', function(){
	...
	//test
	it("Dovrebbe aggiornare il valore dell'attributo $scope.currentNode", function(){
		expect($scope.currentNode).not.toBe(node1);
		$scope.nodeChanged(node1);
		expect($scope.currentNode).toBe(node1);
	});
});
