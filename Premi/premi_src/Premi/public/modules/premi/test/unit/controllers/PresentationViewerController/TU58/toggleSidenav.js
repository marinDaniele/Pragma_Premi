/**
 * File: toggleSidenav.js
 * @author gmidena - rockstar249@gmail.com
 * Data: 2015-06-11
 * Descrizione: Test di unità TU58 Premi::Front-End::Controllers::PresentationViewerController metodo "toggleSidenav"
 */
'use strict';
describe('TU58 Premi::Front-End::Controllers::PresentationViewerController metodo "toggleSidenav"', function(){
	var $scope, $rootScope, $q, errorInGetNodes = false, getNodesError, errorInGetPath = false, getPathError, sidenavOpen,
	currentProject = {
	...
	//test
	it("Dovrebbe invocare il metodo $scope.$broadcast, con il parametro 'presentation-toggleSidenav'", function(){
		sidenavOpen = !$scope.sidenavOpen;
		$scope.toggleSidenav();
		expect($scope.sidenavOpen).toBe(sidenavOpen);
	});
});
