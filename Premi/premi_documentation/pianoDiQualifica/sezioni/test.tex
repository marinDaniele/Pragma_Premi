\section{Specifica dei test}\label{pianificazioneTest}
Il \gloxy{team} \gruppo, al fine di implementare del software che sia di qualità, ha strutturato dei test atti a verificare che il software prodotto rispecchi le funzionalità a fronte di risultati attesi.
...
\item \textbf{Test di validazione [TV]:} con questa tipologia di test si vuole verificare che il lavoro prodotto soddisfi quanto richiesto dal \gloxy{proponente}.
\end{itemize}
\input{sezioni/tabelleTest.tex}
